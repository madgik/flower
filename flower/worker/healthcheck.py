from flower.celery_app_conf import CELERY_APP_QUEUE_MAX_PRIORITY
from flower.celery_app_conf import get_celery_app
from flower.worker import config as node_config

HEALTHCHECK_TASK_SIGNATURE = "flower.worker.celery_tasks.node_info.healthcheck"
